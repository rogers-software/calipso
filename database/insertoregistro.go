...
func InsertoRegistro(db *sql.DB, u models.Usuario) (int, bool, error) {
	...
	if err != nil {
		fmt.Println("Error al encriptar password->", err)
	}
	...
	var pk int
	err = db.QueryRow(query, u.Nombre, u.Apellidos, u.FechaNacimiento, u.Email, u.Password, u.Avatar, u.Banner, u.Biografia, u.Ubicacion, u.SitioWeb).Scan(&pk)
	if err != nil {
